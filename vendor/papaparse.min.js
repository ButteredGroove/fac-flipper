...
((e, t) => {
      ...
      (this.parseChunk = function (t, e) {
        ...
        if (this.isFirstChunk && 0 < i) {
          ...
          e ||
            ...
            (e = this._handle.guessLineEndings(t, r))),
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          (t = r.meta.cursor),
            (i =
              (this._finished ||
                ((this._partialLine = i.substring(t - this._baseIndex)),
                (this._baseIndex = t)),
  ...
  function i(m) {
    ...
    U(m.step) &&
      ...
      (this.pause = function () {
        (l = !0),
          s.abort(),
          (n = U(m.chunk) ? "" : n.substring(s.getCharIndex()));
      }),
      (this.resume = function () {
        i.streamer._halted
          ? ((l = !1), i.streamer.parseChunk(n, !0))
  ...
  function E(C) {
    ...
    !0 === x
      ? (x = "#")
      : ("string" != typeof x || -1 < v.BAD_DELIMITERS.indexOf(x)) && (x = !1),
      "\n" !== O && "\r" !== O && "\r\n" !== O && (O = "\n");
    var z = 0,
      M = !1;
    (this.parse = function (i, t, r) {
        ...
        if (i[z] === F)
          for (m = z, z++; ; ) {
            ...
            if (F === j && i[m + 1] === j) m++;
              ...
              var y = v(
                -1 === (g = -1 !== g && g < m + 1 ? i.indexOf(O, m + 1) : g)
                  ? p
                  : Math.min(p, g),
              );
      ...
      function v(e) {
        var t = 0;
        return (t =
          -1 !== e && (e = i.substring(m + 1, e)) && "" === e.trim()
            ? e.length
            : t);
      }
      function E(e) {
        ...
        return (
          ...
          "string" == typeof e
            ...
            : !0 === e.readable && U(e.read) && U(e.on)
              ? (i = new p(t))
              : ((n.File && e instanceof File) || e instanceof Object) &&
                (i = new l(t)),
          i.stream(e)
        );
      ((i = (() => {
